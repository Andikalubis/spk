...
<div class="alert alert-info">
	Didalam setiap Kriteria terdapat beberapa kategori yaitu : <br>
	1. Sosial (Gotong royong, Ketersedian publik, Kelompok olahraga, Fasilitas olahraga, Poskamling, Siskamling, Konflik) <br>
	2. Kesehatan (Bidan, Dokter, nakes lain, bpjs, Posyandu, Poskesdes) <br>
	3. Pendidikan (SD, SMP, SMA/SMK, PAUD, Paket ABC, Kursus, Taman baca/Perpustakaan desa)<br>
	4. Permukiman (Air Minum, Air mandi dan cuci, jamban, Pembuangan sampah, Sinyal telepon, Internet kantor desa)<br>
	5. Ekonomi (Kelompok pertokoan, Pasar, Warung kelontong, Penginapan, Pos logistik, Bumdes) <br>
	6. Lingkungan (Pencemaran, Bencana, Mitigasi).
